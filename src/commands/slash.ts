...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  { name: 'agents', usage: '/agents [add|edit|remove]', description: 'Lista, cria e gerencia até 12 agentes colaborativos.', category: 'Agent', template: '/agents' },
  { name: 'project', usage: '/project [add|new|root] <path|nome>', description: 'Mostra, registra ou cria projeto. /project root muda a pasta padrão projects.', category: 'Project', template: '/project ' },
